...
<div class="container-fluid">
	<div class="form-head mb-sm-5 mb-3 d-flex flex-wrap align-items-center">
		<h2 class="font-w600 title mb-2 me-auto ">{{$title}}</h2>
			...
			<div class="card card-coin">
				<div class="card-body text-center">
					...
					<p class="mb-0 fs-14">
						...
						<span class="me-1">Total All User</span>
					</p>	
				</div>
			</div>
		</div>
		<div class="col-xl-3 col-sm-6 m-t35">
			<div class="card card-coin">
				<div class="card-body text-center">
					...
					<h2 class="text-black mb-2 font-w600">{{$product}}</h2>
					<p class="mb-0 fs-13">
						...
						<span class=" me-1">Total All Product</span>
					</p>	
				</div>
			</div>
		</div>
		<div class="col-xl-3 col-sm-6 m-t35">
			<div class="card card-coin">
				<div class="card-body text-center">
					...
					<h2 class="text-black mb-2 font-w600">{{$location}}</h2>
					<p class="mb-0 fs-14">
						{{-- <svg width="29" height="22" viewBox="0 0 29 22" fill="none" xmlns="http://www.w3.org/2000/svg">
						...
						<span class=" me-1">Total Location Store</span>
					</p>	
				</div>
			</div>
		</div>
		<div class="col-xl-3 col-sm-6 m-t35">
			<div class="card card-coin">
				<div class="card-body text-center">
					...
					<h2 class="text-black mb-2 font-w600">{{$banner}}</h2>
					<p class="mb-0 fs-14">
						{{-- <svg width="29" height="22" viewBox="0 0 29 22" fill="none" xmlns="http://www.w3.org/2000/svg">
						...
						<span class=" me-1">Total Banner Image</span>
					</p>	
				</div>
			</div>
		</div>
